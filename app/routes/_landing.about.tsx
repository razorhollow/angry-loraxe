...
const people = [
    {
        ...
        bio: 'Mark, one half of the brother duo leading Angry Loraxe, brings a wealth of management experience to the company. Having managed several large corporations, he excels in fostering exceptional customer service and building strong, cohesive teams. Before his foray into management, Mark spent seven years in the oilfield industry. There, he gained invaluable expertise in personal safety protocols, working under high-pressure conditions, and ensuring equipment operated at peak performance through rigorous lab testing and assessments. His diverse background contributes significantly to the high standards and quality of service that Angry Loraxe is known for today.',
    ...
    },
    {
        ...
        bio: <>Josh, the other brother behind Angry Loraxe, is a dedicated forester with a degree from {" "}
            ...
            >
                Paul Smith&apos;s College</a>. His education deepened his appreciation for trees and the unique impact each species has on our environment. Following graduation, Josh applied his knowledge at Cummins Lumber, where he honed his skills over several years. Passionate about continual learning, he has earned multiple certifications in the safe and precise felling of trees. Whether working in the woods or engaging in further education, Josh&apos;s commitment to professionalism and environmental stewardship ensures that Angry Loraxe delivers expert tree services with a conscientious approach.</>,
        linkedinUrl: null,
    },
];
