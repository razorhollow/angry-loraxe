...
const socialLinks = [
    { name: 'Facebook', href: 'https://www.facebook.com/p/Angry-Loraxe-Tree-Service-100047496102714/', icon: (props) => (
    ...
    { name: 'LinkedIn', href: 'https://www.linkedin.com/in/mark-sempler-3341b368/', icon: (props) => (
