...
import stumpGrindingAssetUrl from "~/assets/servicesGraphics/stump-grinding.png";
    ...
    return (
        <div className="bg-neutral-100 py-24 sm:py-32">
            <div className="mx-auto max-w-2xl px-6 lg:max-w-7xl lg:px-8">
                ...
                <p className="w-full text-3xl font-bold tracking-tight text-gray-900 lg:w-[50%]">
                    Comprehensive tree care and land solutions tailored to keep your
                    property safe, beautfiul, and thriving year-round.
                </p>
                    ...
                    <div className="relative lg:col-span-3">
                        ...
                        <div className="relative flex h-full flex-col overflow-hidden rounded-[calc(theme(borderRadius.lg)+1px)] max-lg:rounded-t-[calc(2rem+1px)] lg:rounded-tl-[calc(2rem+1px)]">
                            ...
                            <div className="p-10 pt-4">
                                <h3 className="text-sm/4 font-semibold text-primary-500">
                                    Tree Removal
                                </h3>
                                ...
                                <p className="mt-2 max-w-lg text-sm/6 text-gray-600">
                                    Safe and efficient tree removal to protect your property and
                                    landscape.
                                </p>
                            </div>
                        </div>
                    ...
                    <div className="relative lg:col-span-2">
                        ...
                        <div className="relative flex h-full flex-col overflow-hidden rounded-[calc(theme(borderRadius.lg)+1px)] lg:rounded-bl-[calc(2rem+1px)]">
                            ...
                            <div className="p-10 pt-4">
                                ...
                                <p className="mt-2 max-w-lg text-sm/6 text-gray-600">
                                    Quick and thorough storm debris cleanup to restore your
                                    property.
                                </p>
                            </div>
                        </div>
                    ...
                    <div className="relative lg:col-span-2">
                        ...
                        <div className="relative flex h-full flex-col overflow-hidden rounded-[calc(theme(borderRadius.lg)+1px)] max-lg:rounded-b-[calc(2rem+1px)] lg:rounded-br-[calc(2rem+1px)]">
                            ...
                            <div className="p-10 pt-4">
                                ...
                                <p className="mt-2 text-lg/7 font-medium tracking-tight text-gray-950">
                                    Clear Overgrowth Fast
                                </p>
                                <p className="mt-2 max-w-lg text-sm/6 text-gray-600">
                                    Efficient brush-hogging to clear overgrown land and maintain
                                    open spaces.
                                </p>
                            </div>
                        </div>
